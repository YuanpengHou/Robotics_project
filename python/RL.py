...
parser.add_argument('--inputs', type=int, default=64, metavar='N',
                    help='number of data inputs to the neural network')
parser.add_argument('--actions', type=int, default=2, metavar='N',
                    help='number of output actions from the neural network')
parser.add_argument('--hidden', type=int, default=128,
                    metavar='N', help='number of hidden neurons')
