...
parser.add_argument('--width', type=int, default=512,
                    metavar='N', help='width of virtual screen')
parser.add_argument('--height', type=int, default=512,
                    metavar='N', help='height of virtual screen')
parser.add_argument('--channels', type=int, default=3,
                    metavar='N', help='channels in the input image')
parser.add_argument('--actions', type=int, default=3, metavar='N',
                    help='number of output actions from the neural network')
...
parser.add_argument('--learning_rate', type=float, default=0.0,
                    metavar='N', help='optimizer learning rate')
parser.add_argument('--replay_mem', type=int, default=10000,
                    metavar='N', help='replay memory')
...
parser.add_argument('--epsilon_start', type=float, default=0.9,
                    metavar='N', help='epsilon_start of random actions')
parser.add_argument('--epsilon_end', type=float, default=0.05,
                    metavar='N', help='epsilon_end of random actions')
parser.add_argument('--epsilon_decay', type=float, default=200,
                    metavar='N', help='exponential decay of random actions')
parser.add_argument('--allow_random', type=int, default=1,
                    metavar='N', help='Allow DQN to select random actions')
parser.add_argument('--debug_mode', type=int, default=0,
                    metavar='N', help='debug mode')
parser.add_argument('--use_lstm', type=int, default=0,
                    metavar='N', help='use LSTM layers in network')
parser.add_argument('--lstm_size', type=int, default=32,
                    metavar='N', help='number of inputs to LSTM')
...
def optimize_model():
    ...
    if use_lstm:
        lstm_batch_hx, lstm_batch_cx = model.reset_states(
            lstm_batch_hx, lstm_batch_cx)
        lstm_final_hx, lstm_final_cx = model.reset_states(
            lstm_final_hx, lstm_final_cx)
    ...
    if use_lstm:
        model_batch, (lstm_batch_hx, lstm_batch_cx) = model(
            (state_batch, (lstm_batch_hx, lstm_batch_cx)))
    else:
    ...
    if use_lstm:
        final_batch, (lstm_final_hx, lstm_final_cx) = model(
            (non_final_next_states, (lstm_final_hx, lstm_final_cx)))
...
def next_reward(reward, end_episode):
    ...
    if end_episode:
        ...
        if use_lstm:
            lstm_actor_hx, lstm_actor_cx = model.reset_states(
                lstm_actor_hx, lstm_actor_cx)
